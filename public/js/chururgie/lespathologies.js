...
function creerLalistePathologie($ListeOrgane, $ListeClassePathologie, $ListeTypePathologie) {
    ...
    $liste = "<div id='Pathologie_" + (index + 1) + "'>" +
            ...
            "<th id='Selectorgane_" + (index + 1) + "' style='width: 29%;'>";
    ...
    $liste += "</th>" +
            "<th id='selectClassePathologie" + (index + 1) + "' style='width: 29%;'  >" +
            ...
            "</th >" +
            "<th id='notePathologie2_" + (index + 1) + "' style='width: 29%;'  >" +
            "<khassTypePathologie><input type='text' id='typepathologie" + (index + 1) + "' name='typepathologie" + (index + 1) + "' style='float: left; width: 80%; margin-top: 3px; height: 30px; margin-bottom: 0px; font-size: 15px; padding-left: 10px;' > </khassTypePathologie>" +
            "</th >" +
